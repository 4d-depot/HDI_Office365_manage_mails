# HDI_Office365_manage_mails

Manage mails through the Microsoft GRAPH API (4D v19 R8) 

Find more information on the [blog post](https://blog.4d.com/microsoft-365-copy-move-reply-and-delete-emails-with-the-microsoft-graph-api/).
